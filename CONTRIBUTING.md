...
| Directory | Use when… |
| --------- | --------- |
| `applets/` | Script needs no user editing before use |
| `drivers/` | Script implements a hardware driver for a new peripheral |
| `tools/` | Script is a utility (logging, monitoring, helper) |
...
-- Format the current buffer: :lua vim.lsp.buf.format()
```
